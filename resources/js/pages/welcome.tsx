        ...
        <>
            ...
            >
                ...
                <header className="landing-glass landing-glass-border sticky top-0 z-50 w-full shadow-sm">
                    <div className="mx-auto flex min-h-16 max-w-[110rem] items-center justify-between gap-6 px-5 sm:px-6 lg:px-12">
                        <a
                            href="#top"
                ...
                <main>
                    ...
                    >
                        ...
                        <div className="relative mx-auto grid min-h-[calc(100svh-4rem)] max-w-[110rem] items-center gap-12 px-5 py-16 sm:px-6 sm:py-20 lg:grid-cols-[minmax(0,0.86fr)_minmax(0,1.14fr)] lg:gap-16 lg:px-12 lg:pt-16 lg:pb-24">
                    ...
                    >
                        <div className="mx-auto max-w-[110rem] px-5 sm:px-6 lg:px-12">
                            {/* Section header */}
                    ...
                    >
                        ...
                        <div className="relative mx-auto max-w-[110rem] px-5 sm:px-6 lg:px-12">

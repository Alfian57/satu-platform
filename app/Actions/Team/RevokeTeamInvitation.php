...
final class RevokeTeamInvitation
{
    ...
    public function handle(
        ...
        $result = DB::transaction(function () use ($actor, $invitation, $reason, &$expired): TeamInvitation {
            ...
            Gate::forUser($actor)->authorize('revoke', $lockedInvitation);
            ...
            $this->audit->record(
                operation: 'team.invitation.revoked',
                auditable: $lockedInvitation,
                actor: $actor,
                institution: $project->institution,
                before: $before,
            ...
            $lockedInvitation->load('invitee');
            $lockedInvitation->invitee->notify(
                new TeamInvitationRespondedNotification($lockedInvitation, $actor, 'revoked'),
            );
